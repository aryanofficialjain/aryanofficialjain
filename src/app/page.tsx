      ...
      <section id="skills" className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center flex items-center justify-center gap-2">
            <span className="text-green-400">&gt;</span> Tech Skills
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-800/50 p-6 rounded-lg border border-purple-900/50 hover:border-purple-500/50 transition-colors">
              <h3 className="text-xl font-bold mb-4 text-purple-400">Game Development</h3>
              <div className="grid grid-cols-2 gap-4">
                {["Unity", "Unreal Engine", "C#", "Blueprints & C++", "LOD", "Rigging", "Game Design", "3D Modeling", "Animation", "Physics"].map(
                  (skill) => (
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg border border-purple-900/50 hover:border-purple-500/50 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-4">
                {["React", "Next.js", "JavaScript", "TypeScript", "Tailwind CSS", "Node.js", "Express js", "MongoDB", "Git/Github", "Socket.IO"].map(
                  (skill) => (
                    <div key={skill} className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                      <span>{skill}</span>
