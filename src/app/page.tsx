    ...
    <div className="flex justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-fit">
        <div className="bg-gray-800/50 p-6 rounded-lg border border-purple-900/50 hover:border-purple-500/50 transition-colors">
          <h3 className="text-xl font-bold mb-4 text-purple-400 text-center">Game Development</h3>
          <div className="grid grid-cols-2 gap-4">
            {[
              "Unity",  "C# Programming", "LOD", "Unity 3D", "Netcode for GameObjects", "Particle System", "Post Processing", "Git", "Github", "Socket.IO", "Cinemachine", "AI & Pathfindind (NavMesh)", "OOPS",    
